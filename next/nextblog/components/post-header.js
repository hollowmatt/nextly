...
export default function PostHeader( {postData }) {
    ...
    return(
        <>
            <h1 className="text-5xl md:text-7xl lg:text-8xl text-stone-600 font-bold tracking-tighter leading-tight md:leading-none mb-12 text-center md:text-left">{postTitle}</h1>
            ...
            <HeroImg path={postData.coverImage} altText={postTitle} />
        </>
    )
}